...
//webpackChunkName 기능 적용
// /*webpackChunkname: "home" */ 청크의 이름 지정하면 청크의 이름이 같은 것들을 모아서 하나의 청크로 빌드
const Home = () => import(/*webpackChunkname: "home" */ "@/pages/Home.vue");
const About = () => import(/*webpackChunkname: "home" */ "@/pages/About.vue");
const Members = () =>
  import(/*webpackChunkname: "members" */ "@/pages/Members.vue");
const MemberInfo = () =>
  import(/*webpackChunkname: "members" */ "@/pages/MemberInfo.vue");
const Videos = () =>
  import(/*webpackChunkname: "videos" */ "@/pages/Videos.vue");
const VideoPlayer = () =>
  import(/*webpackChunkname: "videos" */ "@/pages/VideoPlayer.vue");
const NotFound = () =>
...
const router = createRouter({
  ...
  routes: [
    ...
    //동적 라우트 : 일정한 패턴의 URL경로를 하나의 라우트에 연결
    {
      ...
      //라우트 정보를 속성으로 연결 props:true 속성 추가
      props: true,
    },
    //중첩 라우트
    {
